export default function SearchBar() {
  return (
    <div className="focus-within:border-2 focus-within:border-primary-500 w-[47%] mt-3 pr-0 border-2 flex flex-row items-center bg-transparent border-primary-400/15 rounded-md justify-between">
      <input
