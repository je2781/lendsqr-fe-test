export default function SearchBar({display}: {display: string}) {
  return (
    <div className={`lg:w-[50.5%] w-[90%] lg:mt-3 pr-0 border-2 lg:flex ${display} flex-row items-center bg-transparent border-primary-400/15 rounded-md justify-between`}>
      <input
